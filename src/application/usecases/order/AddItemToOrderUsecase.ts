...
import { OrderItemRepositoryInterface } from '@triumph-motorcycles/application/repositories/OrderItemRepositoryInterface';
...
export class AddItemToOrderUsecase {
  ...
  async execute(orderId: string, itemId: string): Promise<void | Error> {
