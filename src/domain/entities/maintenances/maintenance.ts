...
import { MissingMotorcycleError, InvalidMaintenanceIntervalError } from '../../errors/maintenances'
export class Maintenance {
    constructor(
        ...
        if (maintenanceIntervalMileage <= 0) {
            throw new InvalidMaintenanceIntervalError("Maintenance interval mileage must be positive.");
        }
        if (maintenanceIntervalTime <= 0) {
            throw new InvalidMaintenanceIntervalError("Maintenance interval time must be positive.");
        }
    }
